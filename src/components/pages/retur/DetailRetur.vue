        ...
        <ion-col class="ion-padding">
          <ion-list>
            ...
            <ion-item lines="none">
              ...
              <ion-input
                readonly
                v-model="detailRetur.jumlahRetur"
                class="ion-text-end"
              ></ion-input>
            </ion-item>
            <ion-item lines="none">
    ...
    async getDetailRetur() {
      try {
        ...
        const dataResult = await axios.get(
          ipConfig + "/retur/detailReturBySales/" + idRetur.value,
          {
            headers: {
        ...
        vm.detailRetur.createdAt = moment(vm.detailRetur.createdAt).format(
          "LL"
        );
